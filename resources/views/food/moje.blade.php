...
@section('content')
    <h1 class="text-3xl font-bold text-yellow-400 mb-6">Moje zamówienia</h1>
    ...
    <div class="space-y-3">
        @forelse($zamowienia as $z)
            <div class="bg-gray-900 border border-gray-800 rounded-xl p-4">
                ...
                @elseif($z->status === 'dostarczone') bg-green-900 text-green-300
        ...
        @empty
            <div class="text-center py-16 text-gray-500">
                ...
                <a href="{{ route('food.menu') }}" class="inline-block mt-4 bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-semibold px-4 py-2 rounded-lg transition">Przejdź do menu</a>
            </div>
        @endforelse
    </div>
@endsection
